...
/**
 * Keeps normal anchor navigation native and predictable.
 * No SPA router intercepts page links, so local HTML routes are
 * allowed to perform a normal same-origin navigation.
 * @returns {void}
 */
function initializeNavigation() {
  selectElements("a.nav-link").forEach((link) => {
    link.addEventListener("click", (event) => {
      ...
      // Explicitly allow the browser to navigate to the target page.
      // No preventDefault() and no forced redirect to index.html.
    });
  });
}
