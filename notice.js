...
/**
 * Expands or collapses an individual notice.
 * @param {MouseEvent} event Click event.
 * @returns {void}
 */
function toggleNoticeDetails(event) {
  const button = event.currentTarget;
  const details = button
    .closest(".glass-content")
    ?.querySelector(".notice-details");
...
document.addEventListener(
  ...
  () => {
    document
      .querySelectorAll(".notice-expand")
      .forEach((button) => {
